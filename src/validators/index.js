...
export const validatePassword = (password, fieldName = 'Password') => {
    ...
    if (password.length < CONFIG.SECURITY.PASSWORD_MIN_LENGTH) {
        throw new ValidationError(`${fieldName} must be at least ${CONFIG.SECURITY.PASSWORD_MIN_LENGTH} characters`);
    }
...
export const validateNewPassword = (password, fieldName = 'Password') => {
...
export const validateName = (value, fieldName, min = 2, max = 100) => {
    if (value === undefined || value === null || value === '') {
        throw new ValidationError(`${fieldName} is required`);
    }
...
export const validateUsername = (value, fieldName = 'Username', min = 3, max = 30) => {
    if (value === undefined || value === null || value === '') {
        throw new ValidationError(`${fieldName} is required`);
    }
    const text = String(value).trim();
...
export const validateHexColor = (value, fieldName = 'Color') => {
    if (value === undefined || value === null || value === '') {
        throw new ValidationError(`${fieldName} is required`);
    }
    const text = String(value).trim();
...
export const validateISODate = (value, fieldName = 'Date') => {
    if (value === undefined || value === null || value === '') {
        throw new ValidationError(`${fieldName} is required`);
    }
    const text = String(value).trim();
...
export const validateInteger = (value, fieldName, opts = {}) => {
    if (value === undefined || value === null || value === '') {
        throw new ValidationError(`${fieldName} is required`);
    }
...
export const validateOptional = (value, validator) => {
    if (value === undefined || value === null || value === '')
        return null;
...
// ───── Express helper ────────────────────────────────────────────
export const respondWithError = (res, error, fallbackStatus = 500) => {
