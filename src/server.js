...
server.use('/api/users', createUsersRouter(models, jwtSecret, runtimeEnv));
...
server.use('/api/invoices', createInvoicesRouter(models, jwtSecret, runtimeEnv));
...
server.use('/api/milestones', createMilestonesRouter(models, jwtSecret, runtimeEnv));
...
server.use('/api/documents', createDocumentsRouter(models, jwtSecret, runtimeEnv));
...
server.use('/api/uploads', createUploadsRouter(jwtSecret, runtimeEnv));
server.use('/api/leads', createLeadsRouter(models, jwtSecret, runtimeEnv, String(runtimeEnv.PASSWORD_SALT || '')));
server.use('/api/portfolios', createPortfoliosRouter(models, jwtSecret, runtimeEnv));
server.use('/api/scopes', createScopesRouter(models, jwtSecret, runtimeEnv));
server.use('/api/quotations', createQuotationsRouter(models, jwtSecret, runtimeEnv));
server.use('/api/sales-incentives', createSalesIncentivesRouter(models, jwtSecret));
server.use('/api/meetings', createMeetingsRouter(models, jwtSecret, runtimeEnv));
...
server.use(async (req, res, next) => {
    try {
        ...
        const response = await legacyApp.fetch(request, env);
