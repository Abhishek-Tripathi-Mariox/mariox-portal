...
settings.put('/', requireRole('admin'), async (c) => {
    try {
      ...
      WHERE id='settings-1'
    `).bind(body.company_name || 'DevTrack Pro', body.default_daily_hours || 8, body.default_working_days || 22, body.alert_threshold_hours || 0.8, body.overtime_threshold || 10, body.inactivity_days || 3).run();
