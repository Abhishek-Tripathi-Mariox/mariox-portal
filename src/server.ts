...
const localMongoDb = String(runtimeEnv.LOCAL_MONGO_DB || runtimeEnv.MONGODB_URI || 'mongodb://127.0.0.1:27017/mariox-portal')
const mongoUrl = new URL(localMongoDb)
const mongoUri = `${mongoUrl.protocol}//${mongoUrl.host}`
