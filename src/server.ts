...
server.use('/api/users', createUsersRouter(models, jwtSecret, runtimeEnv as any))
...
server.use('/api/documents', createDocumentsRouter(models, jwtSecret, runtimeEnv as any))
