  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'leads.delete',   label: 'Delete leads',
        description: 'Soft-delete leads with a recorded reason — items move to the Lead Trash and can be restored.' },
      { key: 'leads.trash.view', label: 'View Lead Trash',
        description: 'See the Lead Trash module listing soft-deleted leads with their deletion reason, deleter, and timestamp.' },
      { key: 'leads.trash.restore', label: 'Restore deleted leads',
        description: 'Restore soft-deleted leads from the Lead Trash back into the active list.' },
      { key: 'leads.trash.purge', label: 'Permanently delete leads',
        description: 'Hard-delete leads from the Lead Trash — removes the lead and every related task, note, comment, and activity. Cannot be undone.' },
